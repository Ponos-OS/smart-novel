"""
DashScope-compatible TTS server backed by Qwen3-TTS, matching the contract Beatrice's
Qwen3TtsProvider expects from the real Alibaba Cloud DashScope API:
